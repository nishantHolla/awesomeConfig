...
dashboard_sm.components.tags = require("widgets.pages.dashboard.components.windowTags")
...
dashboard_sm.components.reminders = require("widgets.pages.dashboard.components.reminders")
...
dashboard_sm.start = function()
	...
	dashboard_sm.components.reminders.refresh()
